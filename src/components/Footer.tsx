    ...
    <footer className="bg-gray-100 pt-12 pb-6">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-bold text-lg mb-4">Thermal Printer Labels NZ</h3>
            <p className="text-gray-600 mb-4">
              Premium thermal labels with next-day delivery across New Zealand. Trusted by businesses nationwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-600">info@thermallabelsnz.co.nz</span>
              </li>
              <li className="flex items-start">
