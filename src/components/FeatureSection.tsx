    ...
    <section className="py-16 bg-gray-50">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="heading-lg mb-4">Why Choose Our Thermal Labels?</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            We provide top-quality thermal printer labels backed by exceptional service and fast delivery across New Zealand.
          </p>
        </div>
